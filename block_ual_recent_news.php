...
class block_ual_recent_news extends block_base {
    function init() {
        $this->title = get_string('pluginname', 'block_ual_recent_news');
    }
        ...
        /// Accessibility: markup as a list.
            ...
            foreach ($discussions as $discussion) {
                ...
                $text .= '<li class="post">'.
                         ...
                         '<div class="info"><a href="'.$CFG->wwwroot.'/mod/forum/discuss.php?d='.$discussion->discussion.'">'.$discussion->subject.
                         '</a></div>'.
